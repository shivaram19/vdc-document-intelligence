      ...
      <div class="grid md:grid-cols-3 gap-4 items-start">
        <div class="md:col-span-2">
          ...
          <div class="flex flex-wrap gap-2 text-xs font-mono">
            <span class="px-2 py-1 rounded-sm bg-bp-mid text-neutral-500 border border-bp-light/30">node-a: Finder</span>
            <span class="px-2 py-1 rounded-sm bg-bp-mid text-neutral-500 border border-bp-light/30">node-e: Librarian</span>
            <span class="px-2 py-1 rounded-sm bg-bp-mid text-neutral-500 border border-bp-light/30">node-f: Spotter</span>
            <span class="px-2 py-1 rounded-sm bg-bp-mid text-neutral-500 border border-bp-light/30">node-g: Drafter</span>
          </div>
        </div>
        <div class="card-structural">
          ...
          <div id="agent-log" class="space-y-0 max-h-[140px] overflow-y-auto text-xs font-mono">
            <div class="text-neutral-600 italic py-2">Waiting for agent events...</div>
          </div>
        </div>
      </div>
    </section>
