  ...
  return `
    <div class="grid lg:grid-cols-2 gap-4">
      <div class="card-structural">
        ...
        <div class="space-y-4">
          <div>
            <label class="text-sm text-gray-500 block mb-1 font-mono">RFI NUMBER</label>
          ...
          <div>
            <label class="text-sm text-gray-500 block mb-1 font-mono">QUESTION / ISSUE</label>
      ...
      <div class="card-structural">
        ...
        <div id="rfi-draft-output" class="bg-bp-dark/50 rounded-sm p-4 text-sm text-gray-300 whitespace-pre-wrap min-h-[200px] border border-bp-light/20 font-mono">
          <p class="text-gray-600 italic">Your drafted RFI response will appear here with cited sources.</p>
        </div>
