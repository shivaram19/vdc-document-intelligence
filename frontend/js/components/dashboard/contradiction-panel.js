    ...
    <div class="card-structural">
      <div class="flex items-center justify-between mb-6">
        <div>
          ...
          <p class="text-sm text-neutral-500 mt-1">Spotter Agent scans your documents for conflicts that cause rework.</p>
        </div>
        ...
        <div class="bg-bp-dark/60 rounded-sm p-5 border border-safe-yellow/20 fade-in">
          ...
          <div class="grid md:grid-cols-2 gap-3">
            <div class="bg-bp-dark/50 rounded-sm p-3 border-l-2 border-bp-accent">
              ...
              <p class="text-xs text-neutral-400">${c.spec_text || c.details?.[0]?.contexts?.[0] || ''}</p>
            </div>
            <div class="bg-bp-dark/50 rounded-sm p-3 border-l-2 border-safe-orange">
              ...
              <p class="text-xs text-neutral-400">${c.drawing_text || c.details?.[0]?.contexts?.[1] || ''}</p>
            </div>
          </div>
        </div>
      `).join('')}
