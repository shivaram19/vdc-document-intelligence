        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-[10px] text-neutral-500 font-mono">${targets.length} TARGETS</p>
            </div>
          </div>
          <i class="fas fa-chevron-down text-neutral-600 text-xs group-open:rotate-180 transition-transform"></i>
        </div>
        <p class="text-xs text-neutral-400 mt-2">${tier.headline}</p>
