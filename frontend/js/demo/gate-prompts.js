    ...
    <div class="card-structural border-safe-orange/40 bg-safe-orange/5 my-4">
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-gray-400 mb-3">${msg.body}</p>
          <button class="btn-inspect text-xs py-2 px-4" id="demo-gate-cta">
            <i class="fas fa-unlock mr-2"></i>${msg.cta}
          </button>
          <p class="text-[10px] text-gray-600 mt-2 font-mono">${msg.sub}</p>
        </div>
      </div>
    </div>
  `;
  ...
  return `
    <div class="fixed bottom-0 left-0 right-0 bg-safe-orange/10 border-t border-safe-orange/30 px-6 py-2 z-50 flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <span class="text-xs text-gray-400 font-mono">Your demo data is temporary. <strong class="text-white">Request access</strong> to preserve your work.</span>
      </div>
      <div class="flex items-center gap-3">
        <span class="text-[10px] text-gray-500 font-mono">Queries: <span id="demo-q-count">3</span> left</span>
        <span class="text-[10px] text-gray-500 font-mono">Uploads: <span id="demo-u-count">1</span> left</span>
